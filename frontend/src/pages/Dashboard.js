  ...
  return (
    <DashboardContainer>
      ...
      <StatsGrid>
        ...
        <StatCard style={{'--index': 2}}>
          <StatHeader>
            <StatIcon color="#f093fb">
              <TrendingUp size={24} />
            </StatIcon>
          </StatHeader>
          <StatValue>{metrics?.ml_accuracy || 0}%</StatValue>
          <StatLabel>ML Accuracy</StatLabel>
        </StatCard>

        <StatCard style={{'--index': 3}}>
          <StatHeader>
